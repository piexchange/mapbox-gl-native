...
jni::Object<JsonObject> JsonObject::New(jni::JNIEnv& env, std::unordered_map<std::string, mapbox::geometry::value>){
...
//        jni::String key = jni::Make<std::string>(env, item.first));
