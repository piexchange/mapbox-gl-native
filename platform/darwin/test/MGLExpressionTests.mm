...
- (void)testInterpolationExpressionObject {
    ...
    }
    {
        ...
        NSArray *parameters = @[ MGLConstantExpression(@0.42), MGLConstantExpression(@0), MGLConstantExpression(@0.58), MGLConstantExpression(@1) ];
        ...
        NSExpression *interpolateExpression = [NSExpression mgl_expressionForInterpolateFunction:[NSExpression expressionForKeyPath:@"x"]
                                                                                      ...
                                                                                      parameters:[NSExpression expressionForAggregate:parameters]
