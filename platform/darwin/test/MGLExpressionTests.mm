...
- (void)testConditionalExpressionObject {
    {
        NSExpression *expression = [NSExpression expressionWithFormat:@"FUNCTION(%@, 'mgl_case')", @[[NSExpression expressionWithFormat:@"%@", [NSPredicate predicateWithFormat:@"1 = 2"]],
    ...
    }
    {
        NSExpression *expression = [NSExpression expressionWithFormat:@"FUNCTION(%@, 'mgl_case')", @[[NSExpression expressionWithFormat:@"%@", [NSPredicate predicateWithFormat:@"1 = 2"]],
                                                                                                 MGLConstantExpression(@YES),
                                                                                                 [NSExpression expressionWithFormat:@"%@", [NSPredicate predicateWithFormat:@"0 = 1"]],
                                                                                                 MGLConstantExpression(@NO),
                                                                                                 [NSExpression expressionWithFormat:@"%@", [NSPredicate predicateWithFormat:@"4 = 5"]],
                                                                                                 MGLConstantExpression(@NO),
                                                                                                 [NSExpression expressionWithFormat:@"%@", [NSPredicate predicateWithFormat:@"1 = 1"]],
                                                                                                 MGLConstantExpression(@YES),
                                                                                                 MGLConstantExpression(@NO)]];
        NSArray *jsonExpression = @[@"case", @[@"==", @1, @2], @YES, @[@"==", @0, @1], @NO, @[@"==", @4, @5], @NO, @[@"==", @1, @1], @YES, @NO];
        XCTAssertEqualObjects(expression.mgl_jsonExpressionObject, jsonExpression);
        XCTAssertEqualObjects([NSExpression mgl_expressionWithJSONObject:jsonExpression], expression);
        XCTAssertEqualObjects([expression expressionValueWithObject:nil context:nil], @YES);
    }
